...
if(mysql_num_rows($show)){
    ...
    $data = mysql_fetch_assoc($show); //mengambil data ke database yang nantinya akan ditampilkan di form edit di bawah
            ...
            <div class="col-sm-7">
              <div class="product-information"><!--/product-information-->
                ...
                <span>
                  ...
                  <span>
                  <label>Jumlah :</label>
                  <input type="number" class="span1" name="jumlah" min="1" max="<?php echo $data['stok_produk'];?>" autofocus required="" placeholder="0">
      ...
      $tombolbeli="<a href=\"produk-$data[id_produk]-$data[nama_produk].html\" class='btn btn-default add-to-cart'><i class='fa fa-shopping-cart'></i>Beli Produk</a>";
