...
// selesai,,, untuk memanggil ID otomatis ini  bisa memasangkan cara
    ...
    <div class="container">
      ...
      <div class="col-sm-6 col-md-6">
       ...
       <div class="thumbnail">
            <div class="caption">
                <h3>Data Pengiriman <span class="fa fa-fw fa-credit-card"></span></h3>
            </div>
            <div role="tabpanel">

                <!-- Nav tabs -->
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#cod" aria-controls="home" role="tab" data-toggle="tab">Pembeli</a></li>
                </ul>
                        ...
                        <form id="defaultForm" class="form-horizontal" method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input class="form-control" type="text" name="kd_pos" placeholder="Kode Pos" required="" value="<?php echo "$dataPos"; ?>">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                <input class="form-control" type="text" name="telp" placeholder="Nomor Telpon" required="" value="<?php echo "$dataNoTelp"; ?>">
                              </div>
                            </div>
                        ...
                        <label class="col-sm-4 control-label"></label>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-10">
                                    <button type="submit" name="btnSimpan" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span> Proses</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <form method="POST" action="">
            ...
            while (($count < $rpp) && ($i < $tcount)) {
                ...
                $nomor  = 0;
                  ...
                  $subTotal= $user['harga_keranjang'] * $user['qty_keranjang']; 
                  
                  // Mendapatkan total harga  dari seluruh  barang
                  $totalHarga = $totalHarga + $subTotal; 
                  
                  // Mendapatkan total barang
                  $totalBarang = $totalBarang + $user['qty_keranjang']; 
            ...
            ?>
                    <tr>
                      ...
                      <td  class="cart_total" align="center"><h4><strong><?php echo "".$totalBarang; ?></strong></h4></td>
                      <td  class="cart_total"><h4><strong><?php echo "Rp. ".$totalHarga; ?></strong></h4></td>
                      <td>&nbsp;</td>
                    </tr>
            </table>
        </form>
