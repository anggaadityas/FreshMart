...
if(isset($_POST['btnSimpan']))
{
    ...
    // Valiasii id_transaksi, tidak boleh ada yang kembar
        ...
        $mySql  = "INSERT INTO transaksi (id_transaksi,id_member, tanggal_transaksi, total_transaksi, nama_penerima, id_lokasi,alamat_lengkap, kode_pos, no_hp, nama_bank, no_rek, nama_rek)
         VALUES('$nextID','$member','$tanggal','$total_trans', '$member','$id_lokasi', '$alamat', '$kd_pos', '$tlp', '$rek', '$atm', '$nama_rek')";
        ...
        if($myQry){
            ...
            while ($bacaData = mysql_fetch_array($bacaQry)) {
                ...
                $simpanSql="INSERT INTO detail_transaksi(id_member,id_transaksi, id_produk, produk_transaksi, harga_transaksi, qty_transaksi,tgl_transaksi) 
                            VALUES('$member','$nextID', '$Kode_produk', '$Nama', '$Harga', '$Jumlah','$tanggal')";
